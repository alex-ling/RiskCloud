...
import com.miniplat.widget.CheckBox;
...
public class RegistActivity extends BaseActivity implements View.OnClickListener {
    ...
    public static void show() {
        ...
        Intent i = new Intent(ctx, RegistActivity.class);
        ctx.startActivity(i);
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnCheck.setTextOnClick(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                btnCheck.setChecked(true);
                AgreementActivity.show();
            }
        });
    ...
    private void sendOkRequest() {
        ...
        if (TextUtils.isEmpty(mobile)) {
        ...
        else if (!btnCheck.getChecked()) {
            ToastUtil.warn("必须阅读并同意用户协议");
        }
        else {
            // 设置不能重复点击
            ...
            params.put("regtype", AppCtx.REGIST_TYPE);
            params.put("clientid", AppCtx.APP_ID);
            Http.postResJson("api/auth/postuser?app=home&ds=user.regist", params, new JsonHandler() {
                @Override
